    ...
    return (
        <>
            ...
            <div className=' w-[838px] h-auto mt-10 place-content-center ml-64 flex flex-col'>
                <div id='searchbox' className='self-center flex flex-row items-center w-[550px] rounded-lg bg-[#ebd7c4] h-10'>
                    <input type='search' placeholder=' Search...'  className='focus:outline-none focus:ring focus:ring-[#CDA274]  place-items-center placeholder-[#CDA274] cursor-text  w-[500px] h-10 rounded-lg  bg-[#ebd7c4]'>
                    </input>
                    <svg className='ml-3 hover:cursor-pointer' width="18" height="18" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div id='latest-post' className='mt-12'>
                    <p className='font-[DMSerifDisplay] font-normal text-4xl'>Latest Post</p>
                    <div className='flex flex-row mt-10 h-80 '>
                        <img src={images.article} className='w-[450px]'>
                        </img>
                        <div className='ml-10 font-[DMSerifDisplay]  flex flex-col'>
                            <p className='mt-5 font-semibold text-xl'>Low Cost Latest Invented Interior Designing Ideas</p>
                            <p className='mt-12 font-light text-base'>Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpis dignissim maximus.posuere in.Contrary to popular belief. Lorem Ipsum is not simply random text. It has roots in a piece of classica.</p>
                            <div className='flex flex-row items-center mt-10'>
                                <p className='font-light text-sm'>26 December,2022</p>
                                <img src={images.SideV} className='mr-4 hover:cursor-pointer ml-auto h-10 w-8'></img>
                            </div>
                        </div>
                ...
                <p className='font-[DMSerifDisplay] font-normal mt-10 text-4xl'>Articles & News</p>
                <div className='w-[838px] h-[380px] flex flex-row space-x-6 '>
                        <div onClick={Details} className='bg-white hover:bg-[#E7E7E7] cursor-pointer  h-full w-[275px] rounded-t-3xl'>
                        ...
                        <div className='bg-white hover:bg-[#E7E7E7] cursor-pointer h-full w-[275px] rounded-t-3xl'>
                        ...
                        <div className='bg-white hover:bg-[#E7E7E7] cursor-pointer h-full flex flex-col w-[275px] rounded-t-3xl'>
