        ...
        <>
            ...
            <div className=' w-[838px] h-auto mt-10 place-content-center ml-64 flex flex-col'>
                <div id='searchbox' className='self-center flex flex-row items-center w-[550px] rounded-lg bg-[#ebd7c4] h-10'>
                    <input type='search' placeholder='Search...' className=' placeholder-[#CDA274] cursor-text  w-[500px] h-10 rounded-lg  bg-[#ebd7c4]'>
                    </input>
                    <svg className='ml-3 hover:cursor-pointer' width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
