...
const Footer = () => {
  return (
    <>
      <div className=' w-[838px] h-auto mt-32 place-content-center ml-64 flex flex-row'>
        <div className='flex flex-col w-1/3'>
          ...
          <p className='mt-5 text-base'>It is a long established fact that a reader will be distracted lookings.</p>
          <div className='flex flex-row space-x-10 mt-5 items-center'>
        ...
        <div className='flex flex-col text-left ml-6 space-y-2'>
        ...
        <div className='flex flex-col text-left w-1/3 ml-10 space-y-2'>
